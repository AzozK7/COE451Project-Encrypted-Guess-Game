...
try:
    ...
    s.connect(('127.0.0.1',9000))								    # Specify IP of the server for the client to connect to  
...
##################################################################################################################
    ...
    def AEScipherENC(key,PlainText,IVrecievedDECODED):                          # AES encrypton Function
        ...
        print(Fore.GREEN + Ctext + Style.RESET_ALL)                             # Print the corrosponding Plaintext
